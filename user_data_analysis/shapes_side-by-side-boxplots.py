# -*- coding: utf-8 -*-
"""
Created on Fri May 29 21:16:12 2020
...
def makeData(filename):      
    ...
    for r in range(0,5):
        ...
        for i in range(0,len(x_offset)):
#               img = cv2.imread('Images/'+str(r)+'.jpg', 0)
...
def groupedBoxplots(data,value_variables, id_variables, variable_name, my_palette, xtickLabels,figname,ylabel, xlabel, figure_title,y_min,y_max):
    ...
    sns.boxplot(data = data,
                hue = variable_name, # Shapes in this case
                x = id_variables[0],
                y = 'value',
                order = xtickLabels,
                palette = my_palette,
                saturation = 1, 
#                color=dict(boxes='#1b9e77', whiskers='#7570b3', medians='#b2df8a', caps='#7570b3'),
...
figname = 'grouped-boxplots-shapes-'
